...
class DuathlonPage extends StatefulWidget {
  const DuathlonPage({super.key});

  @override
  State<DuathlonPage> createState() => _DuathlonPageState();
}

class _DuathlonPageState extends State<DuathlonPage> {
  ...
  void initState() {
    Future.delayed(Duration.zero, () {
      ...
      findRaceProvider.searchEventWithOutNavigation(context, category: 696);
    });
                  ...
                  : Column(
                      children: [
                        ...
                        AdvertismentContainer(
                            ...
                            title: CategoryOfBottomNavigation.duathathlon),
                        const SizedBox(height: 10),
                        //
                        Expanded(
