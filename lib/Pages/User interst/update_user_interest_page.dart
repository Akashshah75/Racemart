...
class UpdateUserInterestPage extends StatefulWidget {
  const UpdateUserInterestPage({super.key});

  @override
  State<UpdateUserInterestPage> createState() => _UpdateUserInterestPageState();
}
